# Generated by Django 5.1.1 on 2025-01-02 21:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('friends', models.ManyToManyField(blank=True, related_name='related_to', through='api.Friends', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'user',
